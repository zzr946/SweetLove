...
<div id="contentCon">
    ...
    <ol>
    	...
    	<li class="box03">
        	<a href="javascript:void(0)"><img src="images/logo_03.jpg"></a>
            <a href="javascript:void(0)" id="logo01"><img src="images/logo_05.jpg"></a>
            <a href="javascript:void(0)"><img src="images/logo_07.jpg"></a>
        </li>
        <li>
        	<a href="javascript:void(0)"><img src="images/logo_12.jpg"></a>
            <a href="javascript:void(0)" id="logo02"><img src="images/logo_14.jpg"></a>
            <a href="javascript:void(0)"><img src="images/logo_17.jpg"></a>
        </li>
    </ol>
</div>
<!--页脚-->
<div id="footCon">
    ...
    <ol>
        ...
        <div>
            ...
            <a href="javascript:void(0)" onclick="success()" style="text-decoration: none; display: block;">一键支付</a>
        </div>
    </ol>
    <script type="text/javascript">
    	...
    	function success(){
    		...
    		//console.info(ids);
    		//向后台发送请求
    		location.href="success?uid="+uid+"&ids="+ids;
    	}
