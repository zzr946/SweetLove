...
<div id="contentCon">
	<div class="take-delivery">
	 <div class="status">
	   <h1 style="font-size: 25px">您已成功付款</h1><br>
	   <div class="successInfo">
	     <ul>
	             	<h2 style="font-size: 20px">请认真核对您的收货信息，如有错误请联系客服</h2>
	     </ul>
	     <div class="option">
	       <span class="info">您可以</span>
	        <span><a href="order.jsp" class="J_MakePoint" style="color: red; font-size: 18px">查看已买到的宝贝</a></span>
	        <span style="font-size: 18px">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;</span>
	        <span><a href="order.jsp" class="J_MakePoint" style="color: red; font-size: 18px">查看交易详情</a></span>
	     </div>
	    </div>
	  </div>
	</div>
