...
<div id="contentCon">
	<div class="left">
        ...
        <ul>
            ...
            <li><a href="goods_collectList" class="my">收藏夹</a></li>
        </ul>
    </div>
    <div class="right">
    	<ul >
        ...
        <!-- 收藏的商品列表 -->
        <c:forEach var="goods" items="${goods.data}" varStatus="s">
	        <div onclick="xq(this)" style="width: 285px;height: 310px; margin-top:0px; display:inline-block">
	        	<input type="hidden" value="${goods.id}"><!-- 商品id -->
	        	<div><img src="/goodsphoto/${goods.sample1}" width="285px" height="270px"></div><!-- 商品图片 -->
	        	<p style="font-size: 20px;text-align: center;">${goods.goodsname}</p><!-- 商品名 -->
	        </div>
		</c:forEach>
        <script type="text/javascript">
        //查看商品性情
        	function xq(t){
        		//查询商品详情
        		//获取商品id
        		var id=$(t).children()[0].value;
        		//console.info(id);
        		//向后台发送请求
        		location.href="goods_xiangqing?id="+id;
        	}
        </script>
    </div>
</div>
